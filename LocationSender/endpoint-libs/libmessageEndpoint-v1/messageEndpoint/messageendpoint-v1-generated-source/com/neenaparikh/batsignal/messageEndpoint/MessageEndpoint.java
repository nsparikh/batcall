 ...
 * on 2013-07-28 at 23:08:57 UTC 
 * Modify at your own risk.
 */

package com.neenaparikh.batsignal.messageEndpoint;
...
public class MessageEndpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public SendMessage sendMessage(java.lang.String name, java.lang.Double latitude, java.lang.Double longitude, java.lang.Integer duration) throws java.io.IOException {
    SendMessage result = new SendMessage(name, latitude, longitude, duration);
    initialize(result);
    return result;
  }
  ...
  public class SendMessage extends MessageEndpointRequest<Void> {
    ...
    private static final String REST_PATH = "{name}/{latitude}/{longitude}/{duration}";
     ...
     * @since 1.13
     */
    protected SendMessage(java.lang.String name, java.lang.Double latitude, java.lang.Double longitude, java.lang.Integer duration) {
