...
public class Deviceinfoendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "findDeviceByEmail".
   *
   * This request holds the parameters needed by the the deviceinfoendpoint server.  After setting any
   * optional parameters, call the {@link FindDeviceByEmail#execute()} method to invoke the remote
   * operation.
   *
   * @param email
   * @return the request
   */
  public FindDeviceByEmail findDeviceByEmail(java.lang.String email) throws java.io.IOException {
    FindDeviceByEmail result = new FindDeviceByEmail(email);
    initialize(result);
    return result;
  }

  public class FindDeviceByEmail extends DeviceinfoendpointRequest<com.neenaparikh.locationsender.deviceinfoendpoint.model.DeviceInfo> {

    private static final String REST_PATH = "findDeviceByEmail/{email}";

    /**
     * Create a request for the method "findDeviceByEmail".
     *
     * This request holds the parameters needed by the the deviceinfoendpoint server.  After setting
     * any optional parameters, call the {@link FindDeviceByEmail#execute()} method to invoke the
     * remote operation. <p> {@link FindDeviceByEmail#initialize(com.google.api.client.googleapis.serv
     ...
     * @since 1.13
     */
    protected FindDeviceByEmail(java.lang.String email) {
    ...
    @Override
    public FindDeviceByEmail setAlt(java.lang.String alt) {
      return (FindDeviceByEmail) super.setAlt(alt);
    }

    @Override
    public FindDeviceByEmail setFields(java.lang.String fields) {
      return (FindDeviceByEmail) super.setFields(fields);
    }

    @Override
    public FindDeviceByEmail setKey(java.lang.String key) {
      return (FindDeviceByEmail) super.setKey(key);
    }

    @Override
    public FindDeviceByEmail setOauthToken(java.lang.String oauthToken) {
      return (FindDeviceByEmail) super.setOauthToken(oauthToken);
    }

    @Override
    public FindDeviceByEmail setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (FindDeviceByEmail) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public FindDeviceByEmail setQuotaUser(java.lang.String quotaUser) {
      return (FindDeviceByEmail) super.setQuotaUser(quotaUser);
    }

    @Override
    public FindDeviceByEmail setUserIp(java.lang.String userIp) {
      return (FindDeviceByEmail) super.setUserIp(userIp);
    }
    ...
    public FindDeviceByEmail setEmail(java.lang.String email) {
      this.email = email;
      return this;
    }

    @Override
    public FindDeviceByEmail set(String parameterName, Object value) {
      return (FindDeviceByEmail) super.set(parameterName, value);
    }
  }
